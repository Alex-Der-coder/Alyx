...
const WhoIAm = () => {
  ...
  return (
    <section className="h-[28rem] pt-[7rem] max-[640px]:grid   max-[640px]:justify-center  max-[640px]:h-auto  max-[640px]:w-[90%] min-[640px]:hidden max-[970px]:block" id="whoIAmSection">
